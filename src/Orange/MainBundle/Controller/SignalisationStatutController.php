...
class SignalisationStatutController extends BaseController {
	...
	public function createAction(Request $request, $valide, $id) {
		...
		if ($form->isValid ()) {
			...
			return new JsonResponse ( array (
					'url' => $this->generateUrl ( 'details_signalisation', array (
							'id' => $entity->getSignalisation ()->getId () 
					) ) 
			) );
		}
	...
	public function updateAction(Request $request, $id) {
		...
		if ($editForm->isValid ()) {
			...
			return $this->redirect ( $this->generateUrl ( 'signalisationstatut_edit', array (
					'id' => $id 
			) ) );
		}
	...
	private function createDeleteForm($id) {
		return $this->createFormBuilder ()->setAction ( $this->generateUrl ( 'signalisationstatut_delete', array (
				'id' => $id 
