 ...
 * @ORM\Entity(repositoryClass="Orange\MainBundle\Repository\AnimateurRepository")
 */
class Animateur {
	...
	/**
	 *
	 * @var \Utilisateur @ORM\ManyToOne(targetEntity="Utilisateur", inversedBy="animators")
	 *      @ORM\JoinColumns({
	...
	/**
	 *
	 * @var \Instance @ORM\ManyToOne(targetEntity="Instance", inversedBy="animateur")
	...
	/**
	 *
	 * @var \DateTime @ORM\Column(name="date_affectation", type="date", nullable=true)
	 */
