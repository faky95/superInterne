...
// 				$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
				...
				$this->getActiveSheet()->setCellValue($b.$y, $value->getPorteur()?$value->getPorteur()->getNomComplet():' ')->getColumnDimension($b)->setAutoSize(true);
// 				$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
				$b++;
			}if($b == "G"){
				$this->getActiveSheet()->setCellValue($b.$y, $value->getPorteur()->getStructure()->getArchitectureStructure()?$value->getPorteur()->getStructure()->getArchitectureStructure()->getDirection():' ')->getColumnDimension($b)->setAutoSize(true);
// 				$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
				$b++;
			}if($b == "H"){
				$this->getActiveSheet()->setCellValue($b.$y, $value->getPorteur()->getStructure()->getArchitectureStructure()? $value->getPorteur()->getStructure()->getArchitectureStructure()->getPole():' ')->getColumnDimension($b)->setAutoSize(true);
// 				$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
				$b++;
			}if($b == "I"){
				$this->getActiveSheet()->setCellValue($b.$y, $value->getPorteur()->getStructure()->getArchitectureStructure()?$value->getPorteur()->getStructure()->getArchitectureStructure()->getDepartement():' ')->getColumnDimension($b)->setAutoSize(true);
// 				$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
				$b++;
			}if($b == "J"){
				$this->getActiveSheet()->setCellValue($b.$y, $value->getPorteur()->getStructure()->getArchitectureStructure()?$value->getPorteur()->getStructure()->getArchitectureStructure()->getService():' ')->getColumnDimension($b)->setAutoSize(true);
// 				$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
				$b++;
			}if($b == "K"){
...
// 				$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
				...
				$this->getActiveSheet()->setCellValue($b.$y, $value->getDateCloture() ? $value->getDateCloture()->format('d-m-Y') : 'En Cours')->getColumnDimension($b)->setAutoSize(true);
// 				$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
				$b++;
			}if($b == "R"){
...
// 							'fill' => array(
// 									'type' => \PHPExcel_Style_Fill::FILL_SOLID,
// 									'color' => array('rgb'=> $inst[1] ? $inst[1] : 'ffffff' ),
// 							),
// 							'font' => array(
// 									'bold' => true,
// 									'size' => 13,
// 									'color' => array('rgb' => $inst[1] ? 'ffffff' :'000000')
// 							));
// 					$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($style_instance);
// 					$b++;
// 				}elseif($b == "C"){
// 					$this->getActiveSheet()->setCellValue($b.$y, $values);
// 					$action = array(
// 							'borders' => array('top' => $default_border
// 									,'bottom' => $default_border
// 									,'left' => $default_border
...
// 				}elseif($b == "K"){
// 					$type = explode("##", $values);
// 					$this->getActiveSheet()->setCellValue($b.$y, $type[0])->getColumnDimension($b)->setAutoSize(true);
// 					$style_type = array(
// 							'borders' => array('top' => $default_border
// 									,'bottom' => $default_border
// 									,'left' => $default_border
...
// 									'color' => array('rgb' => 'ffffff')
// 							));
// 					$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($style_type);
// 					$b++;
// 				}elseif($b == "N"){
// 					$this->getActiveSheet()->setCellValue($b.$y, $values);
// 					$cont = array(
...
// 				}
// 				else{
// 					$this->getActiveSheet()->setCellValue($b.$y, $values)->getColumnDimension($b)->setAutoSize(true);
// 					$this->getActiveSheet()->getStyle($b.$y)->applyFromArray($data);
// 					$b++;
// 				}
// 			}
	...
	public function exportSignalisation($arrData){
		$default_border = array('style' => \PHPExcel_Style_Border::BORDER_THIN, 'size' => 20, 'color' => array('rgb'=>'000000'));
		$style_th = array(
				'borders' => array('top' => $default_border
									,'bottom' => $default_border
									,'left' => $default_border
